...
const FALLBACK = [
  {titolo: "Project Moonbound", descrizione: "The project isn't just a game. Once all the challenges are completed, the experience culminates with a visual journey to the Moon and becomes a veritable historical archive. Players are rewarded with an interface that allows them to explore original videos and NASA archive footage for each of the facilities they encounter (from David Scott's original experiment on the Moon to actual footage of the Centrifuge and the N.B.L. pool).", immagine: ["projectmoonbound_1.jpg", "projectmoonbound_2.jpg"], url: "https://riccardovosti.github.io/projectmoonbound/", data: {giorno: 1, mese: 4, anno: 2028}, autore: "Riccardo Vosti", tags: ["game", "historical-archives", "apollo-program", "apollo", "2d"]},
  {titolo: "Perseverance Rover", descrizione: "An interactive page designed for scientific outreach and virtual exploration of the Mars 2020 mission and NASA's Perseverance rover. The project is a digital laboratory where the user stops being a passive spectator and becomes a virtual operator, discovering every detail of the mission.", immagine: ["perseverancerover_1.jpg", "perseverancerover_2.jpg"], url: "https://naheleee.github.io/Progetto_1_PerseveranceRover/", data: {giorno: 3, mese: 12, anno: 2028}, autore: "Nahele Belli", tags: ["rover", "perseverance", "3d", "educational", "mars", "space", "exploration", "mission", "discovery", "robot", "aerospace", "planet"]},
  {titolo: "Radiowave NASA", descrizione: "Radiowave NASA is an interactive digital archive of the ten most iconic audio transmissions in NASA's history, from Armstrong's One Small Step onward. Each recording is paired with synchronized, translated transcriptions shown in real time through expressive, large-scale typography that turns spoken words into a visual experience.", immagine: ["radiowave_1.jpg", "radiowave_2.jpg"], url: "https://claudio-ceppi.github.io/CV429.01-Interaction-Design/Radiowave_NASA/files/", data: {giorno: 28, mese: 4, anno: 2028}, autore: "Claudio Ceppi", tags: ["audio", "huston", "sounds", "apollo", "archive"]},
  {titolo: "Other Worlds", descrizione: "An interactive exploration of 11 confirmed exoplanets from the NASA Exoplanet Archive, selected to show the extreme diversity of worlds beyond our solar system. From planets in the habitable zone to ultra-hot gas giants where it rains molten iron.", immagine: ["otherworlds_1.jpg", "otherworlds_2.jpg"], url: "https://djordjaa.github.io/Other_Worlds/", data: {giorno: 23, mese: 1, anno: 2028}, autore: "Djordja Krsteva", tags: ["planet", "exoplanets", "extreme worlds", "nasa archive", "astronomy", "deep space"]},
  {titolo: "MoonPrint", descrizione: "This interactive archive explores how global media reported the Apollo 11 moon landing in July 1969 through visual comparisons of international newspapers, highlighting differences in tone, language, and perspective. The project shows how countries around the world reacted to this historic event, revealing how culture, politics, and national identity shaped the way the story was told.", immagine: ["moonprint_1.jpg", "moonprint_2.jpg"], url: "https://sofiaribeiromarques.github.io/NASA/", data: {giorno: 12, mese: 10, anno: 2028}, autore: "Sofia Ribeiro Marques", tags: ["archive", "moon", "apollo", "media", "frontpage", "comparison"]},
  {titolo: "Eyes on earth", descrizione: "By combining technical visualization with detailed descriptions of five NASA Earth-observing satellites, this project examines the ongoing impact of climate change. The initiative is designed to illustrate how these satellites operate and why they are essential for monitoring our planet’s health.", immagine: ["eyesonearth_1.jpg", "eyesonearth_2.jpg"], url: "https://carladegennaro.github.io/interaction_design/index.html", data: {giorno: 13, mese: 11, anno: 2028}, autore: "Carla De Gennaro", tags: ["climate", "satellites", "earth", "orbit", "technical", "observatory"]},
  {titolo: "Apollo Landing Archive", descrizione: "Apollo Landing Archive is an interactive website showcasing lunar panoramas built from photographs taken during the Apollo missions. It reimagines Google Earth on the Moon’s surface, allowing users to explore landing sites through immersive, stitched views of the lunar landscape.", immagine: ["lunararchive_1.jpg", "lunararchive_2.jpg"], url: "https://dadiccs.github.io/nasa/", data: {giorno: 6, mese: 11, anno: 2028}, autore: "Daniele Falcone", tags: ["3d", "apollo", "history", "space", "archive", "moon", "panoramic", "missions", "images"]},
  {titolo: "Nebula Vision", descrizione: "Nebula Vision offers a guided journey through the Eagle and Helix nebulae to understand our Solar System. Using the Spitzer Telescope’s infrared tech, the site pierces cosmic dust to reveal scientific data invisible to the naked eye.", immagine: ["nebulavision_1.jpg", "nebulavision_2.jpg"], url: "https://ali-0032.github.io/Nebula_Vision/05_prototipo_3/", data: {giorno: 6, mese: 5, anno: 2028}, autore: "Alissa Bionda", tags: ["astronomy", "space", "nebula", "spitzer", "2d"]},
  {titolo: "SolarScale", descrizione: "Exploring the true scale of the Solar System, often distorted in common representations, this interactive experience visualizes planetary sizes, positions and distances. It reveals the real proportions and spatial relationships between planets in a simplified and intuitive way.", immagine: ["solarscale_1.jpg", "solarscale_2.jpg"], url: "https://lucamazzolaa.github.io/SolarScale/", data: {giorno: 8, mese: 11, anno: 2028}, autore: "Luca Mazzola", tags: ["planet", "3d", "space", "educational", "earth", "solar system", "measurements", "proportions", "orbits", "sun"]},
  {titolo: "Hubble Space Telescope", descrizione: "My project aims to pay tribute to the Hubble satellite. From 1985 to today, thanks to its contribution, we have obtained the first detailed images of space, which have been fundamental for the study and understanding of the universe.", immagine: ["hubble_1.jpg", "hubble_2.jpg"], url: "https://laura-pantani.github.io/NASA-P1/p1/", data: {giorno: 25, mese: 11, anno: 2028}, autore: "Laura Pantani", tags: ["archive", "history", "space", "astronomy"]},
  {titolo: "NEO Protocol", descrizione: "NEO Protocol is a cutting-edge interactive web ecosystem designed to monitor Near-Earth Objects (NEOs) in real time. Developed to celebrate NASA's 70th anniversary, the project transforms complex astrometric data streams from the Jet Propulsion Laboratory (JPL) into a space surveillance interface.", immagine: ["neoprotocol_1.jpg", "neoprotocol_2.jpg"], url: "https://melissabroggini.github.io/NEO_Protocol/", data: {giorno: 10, mese: 2, anno: 2028}, autore: "Melissa Broggini", tags: ["data visualization", "space", "3d", "earth", "science", "neo", "near earth object", "asteroids", "real life data", "radar"]},
  {titolo: "Beyond The Myth", descrizione: "Beyond The Myth is a digital ecosystem mapping the evolution of astronomical knowledge, from myth to scientific proof. Through an interactive timeline, it links key figures and instruments and lets you explore the shift from analog to digital.", immagine: ["beyondthemyth_1.jpg", "beyondthemyth_2.jpg"], url: "https://kikerio.github.io/beyondthemyth/", data: {giorno: 9, mese: 7, anno: 2028}, autore: "Michelle Chicherio", tags: ["history", "paradigms", "myth-busting", "network-navigation", "real-time-data", "epistemology"]},
  {titolo: "Spacesuit evolution", descrizione: "Spacesuit Evolution is a project that explores the evolution of NASA spacesuits from the 1960s to 2011, covering the major human space exploration programs: Mercury, Gemini, Apollo, and the Space Shuttle.", immagine: ["spacesuits_1.jpg", "spacesuits_2.jpg"], url: "https://davidebarattini.github.io/Nasa_Spacesuits/", data: {giorno: 6, mese: 3, anno: 2028}, autore: "Davide Barattini", tags: ["educational", "spacesuits", "mission", "timeline", "visor", "explore"]}
];
